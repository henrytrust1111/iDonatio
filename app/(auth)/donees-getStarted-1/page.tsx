...
const DoneesGetStarted1: React.FC = () => {
  ...
  const [, setAddressObj] = useState<any>(null);
...
const {
  ...
  requestOptions: {
    /* Define any location bounds or country restrictions here if needed */
  },
});
...
const handleSelect = async (address: string) => {
  ...
  try {
    ...
    setAddressObj({ lat, lng, address });
    // You can store lat/lng as well if needed
  } catch (error) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4 order-2 lg:order-1">
                ...
                <div className="relative mt-1">
                  ...
                  />
                  {status === "OK" && (
                    <ul className="absolute z-50 bg-white border rounded mt-1 w-full shadow-md max-h-52 overflow-auto">
